"""
Django settings for rightOnTime project.
...
WSGI_APPLICATION = 'rightOnTime.wsgi.application'
...
if 'test' in sys.argv or 'pytest' in sys.modules:
    ...
    DATABASES['default'] = {
        ...
        'NAME': ':memory:', # Store database in memory (RAM) instead of a file
    }